#!/bin/bash
clear
echo -e "\e[4;31m AlphaElite Productions !!! \e[0m"
echo -e "\e[1;34m Presents \e[0m"
echo -e "\e[1;32m TBombElite \e[0m"
echo "Press Enter To Continue"
read a1
if [[ -s update.alphaeliteofc ]];then
...
echo This Script Was Made By AlphaElite >update.alphaeliteofc
...
toilet -f mono12 -F border AlphaElite
echo -e "\e[4;34m This Bomber Was Created By AlphaElite \e[0m"
...
clear
echo -e "\e[1;32m"
echo 'Call Bomb By AlphaElite'> call.xxx
...
if [[ -s TBombElite/TBombElite.sh ]];then
cd TBombElite
cp -r -f * .. > temp
cd ..
rm -rf  TBombElite >> temp
rm update.alphaeliteofc >> temp
rm temp
...
echo -e "\e[1;33m      [*]  AlphaElite   \e[1;31m"
